    ...
    const componentsModule = {
            ...
            components: [
                ...
                },
                {
                    ...
                    price: 4e5,
                    priceRefund: 1,
                    allowedInputs: { "0:1:left": !0, "0:1:right": !0 },
                    allowedOutputs: { "0:0": !0, "0:1": !0, "0:2": !0 },
                ...
                },
                {
                    ...
                    price: 4e5,
                    priceRefund: 1,
                    allowedInputs: { "1:0:top": !0, "1:0:bottom": !0 },
                    allowedOutputs: { "0:0": !0, "1:0": !0, "2:0": !0 },
                    strategy: { type: "sorter", interval: 1 },
                },
                {
                    id: "ironBuyer",
                ...
                },
                {
                    ...
                    strategy: { type: "buyer", purchaseResources: { oil: { price: 200, amount: 1 } }, outputResourcesOrder: ["oil"], interval: 10 },
                },
                {
                    id: "gasBuyer",
                    idNum: 30,
                    ...
                    priceRefund: 1,
                    requiresResearch: "plasticComponents",
                    strategy: { type: "buyer", purchaseResources: { gas: { price: 80, amount: 1 } }, outputResourcesOrder: ["gas"], interval: 10 },
                },
                {
                    id: "plasticMaker",
                    idNum: 9,
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { oil: { perOutputResource: 4 }, coal: { perOutputResource: 4 }, gas: { perOutputResource: 2 } },
                ...
                },
                {
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { aluminium: { perOutputResource: 4 }, steel: { perOutputResource: 6 }, electronics: { perOutputResource: 3 } },
                ...
                },
                {
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { electronics: { perOutputResource: 3 }, steel: { perOutputResource: 6 }, aluminium: { perOutputResource: 2 } },
                ...
                },
                {
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { tankHull: { perOutputResource: 1 }, tankTurret: { perOutputResource: 1 }, engine: { perOutputResource: 1 } },
                ...
                },
                {
                    ...
                    strategy: {
                        ...
                        resources: {
                            ...
                            rocket: { amount: 1, sellPrice: 0, sellMargin: 2.6, bonus: !0, requiresResearch: "rocketComponents" },
                        },
                        interval: 10,
                    },
                },
                ...
                },
                {
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { aluminium: { perOutputResource: 4 }, electronics: { perOutputResource: 3 }, explosives: { perOutputResource: 8 } },
                ...
                },
                {
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { rocketHull: { perOutputResource: 2 }, warhead: { perOutputResource: 2 }, jetFuel: { perOutputResource: 8 } },
                ...
                },
                {
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { aluminium: { perOutputResource: 64 }, plastic: { perOutputResource: 48 }, electronics: { perOutputResource: 24 }, engine: { perOutputResource: 8 }, guns: { perOutputResource: 32 } },
                ...
                },
                {
                    ...
                    strategy: {
                        ...
                        resources: {
                            ...
                            rocket: { amount: 8, sellPrice: 0, bonus: !0, sellMargin: 6 },
                            jetFuel: { amount: 32, sellPrice: 0, bonus: !0, sellMargin: 3 },
                        },
                        interval: 20,
                    },
                },
                {
                    ...
                    strategy: { type: "researchCenter", researchProduction: 1, resources: { report1: { max: 4, bonus: 2 } }, interval: 10 },
                },
                {
                    id: "metalsLab",
                    idNum: 34,
                    ...
                    strategy: {
                        type: "lab",
                        inputResources: { iron: { perOutputResource: 1, max: 25, bonus: 4 }, steel: { perOutputResource: 1, max: 25, bonus: 6 }, aluminium: { perOutputResource: 1, max: 25, bonus: 5 } },
                ...
                },
                {
                    ...
                    strategy: { type: "researchCenter", researchProduction: 4, resources: { report2: { max: 4, bonus: 3 } }, interval: 20 },
                },
                {
                    id: "analystCenter",
                    idNum: 39,
                    ...
                    strategy: {
                        type: "converter",
                        inputResources: { report1: { perOutputResource: 32, max: 256, bonus: 10 }, report2: { perOutputResource: 32, max: 256, bonus: 10 } },
                ...
                },
                {
                    ...
                    requiresResearch: "analystCenter",
                    applyUpgradesFrom: "researchCenter",
                    strategy: { type: "researchCenter", researchProduction: 20, resources: { report3: { max: 4, bonus: 16 } }, interval: 40 },
                },
                {
                    id: "qualityLab",
                    idNum: 44,
                    ...
                    strategy: {
                        ...
                        production: { report4: { amount: 1, max: 1e3 } },
                ...
                },
                {
                    ...
                    requiresResearch: "qualityCenter",
                    applyUpgradesFrom: "researchCenter",
                    strategy: { type: "researchCenter", researchProduction: 100, resources: { report4: { max: 64, bonus: 100 } }, interval: 40 },
                },
            ],
        };
        (() => {
